 ...
 */
 export const deleteDataInExistingDoc = async (modelName: string, obj: object): Promise<void> => {
    const collection  = mongoose.connection.db.collection(modelName);
 ...
 */
 export const updateKeyInExistingDoc = async (modelName: string, obj: Record<string, string>): Promise<void> => {
    const collection  = mongoose.connection.db.collection(modelName);
